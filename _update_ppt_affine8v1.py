...
SESSIONS = [
    ...
    ("PS93 - 2026-08-05", "FIXED motion; cross-reg to 6/6 (~2mo gap); ONLY 4/6 SPOUT POSITIONS (dead strobe bit1 + empty behavior log; close_center/close_L contaminated); cue 2 s post / 2 s pre",
