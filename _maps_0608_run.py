...
D=r"E:\labcams_data\20260608"; Q=r"E:\DAQ_recorder_output"; TAG="affine8v1"
...
S={"PS92_0608":dict(sess="PS92_20260608_133759",daq=fr"{Q}\PS92_20260608_133847.h5"),
...
def do(k):
    s=S[k]; lab=f"{s['sess'][:4]}_0608_{TAG}"; mc=fr"{D}\{s['sess']}\motion_corrected"
