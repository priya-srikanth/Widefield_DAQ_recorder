...
// Janelia
// HHMI 
// UPDATED 20250426 by RH

#define VERSION "20180514"
// ===== VERSIONS ======

// 20180514 sws
// - DIR pin was set to 12 but hardwrae has it on 2
...
#define SHOW_REVERSE   // if this is defined, show abs value of speed
...
#define encBPin 1
#define dacPin  A14
#define dirPin 2    // 0 = forward,1 = reverse
//#define idxPin  14  // not used here
...
{   
 ...
 //   Serial.print('F');
  ...
  if (dir==BW) // RH EDIT: added this if block to recover negative values for runSpeed
  {
    runSpeed = -runSpeed;
  }
...
{ 
  ...
  {   
      ...
      float dacval = (runSpeed)/MAXSPEED * (maxDACval/2); // RH EDIT: edited from: dacval = runSpeed/MAXSPEED * maxDACval
      dacval = dacval+(maxDACval/2); // RH EDIT: added this line
